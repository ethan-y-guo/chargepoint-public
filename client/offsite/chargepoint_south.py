...
os.mkdir(f'/Users/ethanguo/chargers/south/{stamp_str}')
...
#    plt.scatter(lat, long, marker='.')
    ...
    with open(f'/Users/ethanguo/chargers/south/{stamp_str}/{fname}.json', 'w') as writer:
...
with open(f'/Users/ethanguo/chargers/south/{stamp_str}/tkn.txt', 'w') as writer:
    writer.write(f"{coulomb_tkn} {datetime.utcfromtimestamp(int(coulomb_exp)).strftime('%Y-%m-%d %H:%M:%S')}")
    
with open(f'/Users/ethanguo/chargers/south/{stamp_str}/stats.txt', 'w') as writer:
